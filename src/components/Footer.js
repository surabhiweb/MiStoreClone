  ...
  return (
    <>
      ...
      <div className="footer">
        <div>
          <p>SUPPORT</p>
          {footer.support && footer.support.map((item, index) => (
        ...
        <div>
          <p>SHOP AND LEARN</p>
          {footer.shopAndLearn && footer.shopAndLearn.map((item, index) => (
            <a key={item.url} href={item.url}>
              {item.name}
            </a>
          ))}
        ...
        <div>
          <p>RETAIL STORE</p>
          {footer.retailStore && footer.retailStore.map((item, index) => (
            <a key={item.url} href={item.url}>
              {item.name}
            </a>
          ))}
        ...
        <div>
          <p>ABOUT</p>
          {footer.aboutUS && footer.aboutUS.map((item, index) => (
            <a key={item.url} href={item.url}>
              {item.name}
            </a>
          ))}
        ...
        <div>
          <p>CONTACT US</p>
          {footer.contactUS && footer.contactUS.map((item, index) => (
            <a key={item.url} href={item.url}>
              {item.name}
            </a>
          ))}
